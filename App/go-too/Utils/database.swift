...
class Database{
    ...
    func setQuestions(){
        ...
        //Q2
        Questions.append(questionsDB(questionID: 1, groupID: 0, numOfAnswers: 2, Answers: answers, questionString:"Can anyone help me with problem 3 for homework?", date: "04/28/18", name: "Jovon Johnson"))
